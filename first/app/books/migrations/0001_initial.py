    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Отчество автора')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_publishing_house', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='publishinghouse_books', to='books.publishinghouse', verbose_name='ID издательство')),
            ],
            options={
                'verbose_name': 'Книга',
